...
HD_PWD='/home/ingargio/4IR/Projet_Info/Processor/Processor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Chemin_donnees.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Chemin_donnees.tcl
